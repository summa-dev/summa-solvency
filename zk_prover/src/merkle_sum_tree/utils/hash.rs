...
pub fn poseidon_node<const N_ASSETS: usize>(
    ...
    poseidon::Hash::<Fp, PoseidonSpec, ConstantLength<L_NODE>, 3, 2>::init().hash(hash_inputs)
}
...
pub fn poseidon_entry<const N_ASSETS: usize>(left: Fp, right: [Fp; N_ASSETS]) -> Fp {
    ...
    poseidon::Hash::<Fp, PoseidonSpec, ConstantLength<L_ENTRY>, 3, 2>::init().hash(hash_inputs)
}
