...
use crate::merkle_sum_tree::{MerkleProof, MerkleSumTree, Node, Tree};
    ...
    for AggregationMerkleSumTree<N_ASSETS, N_BYTES>
{
    ...
    fn generate_proof(
        ...
        let mini_tree_index = match mini_tree_index {
            Some(index) => index,
            None => return Err("mini_tree_index must be provided"),
        };
