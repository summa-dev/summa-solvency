...
mod tests {
    ...
    fn test_overflow_251bits_case_2() {
        ...
        let circuit = OverflowCheckCircuit::<12, 21> {
            a: max_balance,
            b: max_balance,
        };
        let invalid_prover = MockProver::run(k, &circuit, vec![]).unwrap();
        ...
        assert_eq!(
            ...
            Err(vec![VerifyFailure::ConstraintNotSatisfied {
                ...
                cell_values: vec![
                    ...
                    (((Any::advice(), 1).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 2).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 3).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 4).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 5).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 6).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 7).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 8).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 9).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 10).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 11).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 12).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 13).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 14).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 15).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 16).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 17).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 18).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 19).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 20).into(), 0).into(), "0xfff".to_string()),
                    (((Any::advice(), 21).into(), 0).into(), "0xffe".to_string()),
                ]
            }])
        );
    }
