...
def generate_spec(t, alpha, R_F, R_P, file_name, suffix):
    with open(file_name, "w") as f:
        ...
        f.write(
            "//! Specification for rate {} Poseidon using the BN256 curve.".format(t)
        )
        f.write("\n")
        f.write(
        ...
        f.write("        (\n")
        f.write(
            "            poseidon_params_{}::ROUND_CONSTANTS[..].to_vec(),\n".format(
                suffix
            )
        )
...
def generate_params(num_assets, file_name):
    with open(file_name, "w") as f:
        ...
        f.write("// Poseidon hasher parameter for Width used in MST nodes\n")
        ...
        f.write("// Poseidon hasher parameter for Width used in MST entries\n")
